...
SPEC=[
 ...
 dict(id='t_spread',teaser='差距的十九年',hook='前段與後段的距離，變近還是變遠',
   ...
   note='281 分。走勢不是單調上升：2006 年 249 分 → 2009 年 224 → 2012 年 215（最平等的一年）→ 2015 年 260 → 2018 年 259（略為收斂）→ 2022 年 267 → 2025 年 281。整體而言 2012 年後擴大了 66 分，但中間曾有一屆持平微降。'),
 dict(id='t_top',teaser='頂尖學生的十九年',hook='世界級的臺灣學生變多還是變少',
   ...
   note='20.1%。從 2012 年的 8.3% 成長到 20.1%，但中間有明顯起伏：2015 年 15.4% → 2018 年掉回 11.7% → 2022 年 17.8% → 2025 年 20.1%。十三年整體約成長 2.4 倍，不是逐屆遞增。'),
 dict(id='t_low',teaser='後段學生的十九年',hook='跟頂尖同時發生的另一件事',
   ...
   note='12.9%。在頂尖比例從 8.3% 升到 20.1% 的同一段期間，後段也從 9.8% 升到 12.9%（其中 2018 年一度高達 15.1%）。兩端同時擴張，這與「高低分差距擴大」的方向一致：主要來自頂端拉開，而非後段整體崩落。'),
