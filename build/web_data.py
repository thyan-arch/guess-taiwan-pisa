...
Q=[
 ('成績',2025,'sci_mean','臺灣 15 歲學生的科學平均分數，在全世界排第幾？',
  '三個科學主測年（2006、2015、2025）臺灣都排第 4，母數分別是 57、73、91 個國家／經濟體。','{v:.0f} 分'),
 ('成績',2025,'pct_top','科學能力達到最高等級（L5–6）的「頂尖學生」比例，臺灣排第幾？',
  '20.1%，在 91 個國家／經濟體中排第 3，約為 OECD 平均 7.2% 的 2.8 倍。','{v:.1f}%'),
 ('成績',2025,'sci_spread','臺灣前段班與後段班的分數差距（P90−P10），在世界上排第幾？',
  '281 分，在 91 個國家／經濟體中排第 81（數字愈大代表國內落差愈大）。標準差同期也從 2006 年的 94 分增加到 2025 年的 107 分。PISA 估算 15 歲學生一年學習約值 20 分，但 OECD 提醒這個換算不宜機械套用在國內落差上。','{v:.0f} 分'),
 ...
 ('動機',2025,'enjoyment','臺灣學生「享受科學、覺得學科學有趣」的程度排第幾？',
  '三屆都在中後段：2006 年第 22／57、2015 年第 59／73、2025 年第 57／91。成績三屆都排第 4，樂趣一直是中等。','{v:+.2f}'),
 ...
 ('性別',2025,'gender_gap_sci','臺灣科學成績的性別差距（女生減男生）排第幾？',
  '臺灣女生科學 545 分，男生 535 分，女生領先 10.5 分。女生成績在 91 個國家／經濟體中排第 3。同一屆的日本、美國仍是男生領先。','{v:+.1f} 分'),
 ('性別',2025,'sci_girls','只看女生，臺灣女生的科學成績在全世界排第幾？',
  '在 91 個國家／經濟體中排第 3，只低於中國四省市與新加坡。','{v:.0f} 分'),
 ('城鄉',2025,'urban_rural_gap','臺灣城市學校與鄉村學校的科學分數差距，在世界上排第幾？',
  '差 102 分，OECD 平均只差 32 分。臺灣城市學校 556 分，在 83 個國家／經濟體中排第 3；鄉村學校 454 分，低於 OECD 平均的 458 分。','{v:.0f} 分'),
 ...
 ('課堂',2025,'rel_infodecision','三個科學子項裡，臺灣在「評估科學資訊、做出決策」相對自己的總分表現，排第幾？',
  '比臺灣自己的科學總分低 11.4 分，在本題的 85 個國家／經濟體中排第 82。要注意這是「相對」強弱：臺灣這一項的絕對分數是 528 分，仍遠高於 OECD 平均的 480 分。它的意思是，在臺灣學生的三項科學能力當中，這一項相對最不突出——2006 年的「辨識科學議題」也是同樣的形狀。','{v:+.1f} 分'),
 ('課堂',2025,'rel_explain','同樣三個子項裡，臺灣在「科學地解釋現象」相對自己總分的表現排第幾？',
  '比臺灣自己的科學總分高 4.4 分，在 85 個國家／經濟體中排第 5。也就是說，三項科學能力裡，「解釋現象」是臺灣相對最突出的一項。','{v:+.1f} 分'),
 ...
 ('課堂',2025,'discipline','臺灣科學課的秩序與紀律，在世界上排第幾？',
  '在 85 個國家／經濟體中排第 9。臺灣的科學課安靜、有秩序，被數位裝置干擾的比例也是第 8 低（13.2%，OECD 28.4%）。','{v:+.2f}'),
 ('課堂',2025,'life_satisfaction','臺灣 15 歲學生的生活滿意度（0–10 分）排第幾？',
  '6.72 分，在 85 個國家／經濟體中排第 76，低於 OECD 平均的 7.22 分。','{v:.2f} 分'),
]
